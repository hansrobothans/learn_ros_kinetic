...
(cl:defmethod cl:initialize-instance :after ((m <Complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_communication-msg:<Complex> is deprecated: use learning_communication-msg:Complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-msg:real-val is deprecated.  Use learning_communication-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-msg:imaginary-val is deprecated.  Use learning_communication-msg:imaginary instead.")
  (imaginary m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Complex>)))
  ...
  "learning_communication/Complex")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Complex)))
  "Returns string type for a message object of type 'Complex"
  "learning_communication/Complex")
